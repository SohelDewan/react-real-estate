        ...
        <div className=" md:flex w-4/5">
          ...
          <div className="w-1/5 ">
            <div className="ml-5 p-5 rounded-xl space-y-8 ">
                <h4 className="text-xl "><span className="text-[#30B6EC] pr-2">price:</span>{singleEstate.price}</h4>
                <h4 className="text-xl "><span className="text-[#30B6EC] pr-2">status:</span>{singleEstate.status}</h4>
                <h4 className="text-xl "><span className="text-[#30B6EC] pr-2">segment_name:</span>{singleEstate.segment_name}</h4>
                <h4 className="text-xl "><span className="text-[#30B6EC] pr-2">location:</span>{singleEstate.location}</h4>
            </div>
          </div>
        </div>
